...
//myservo.attach(b1);
   ...
   for (pos = 26; pos >= 25; pos -= 3) { // goes from 180 degrees to 0 degrees
    myservo.write(pos);              // tell servo to go to position in variable 'pos'
    delay(15);                       // waits 15ms for the servo to reach the position
  }
     for (pos = 25; pos <= 26; pos +=3) { // goes from 0 degrees to 180 degrees
...
void detectKeyPresses() {
    ...
    else if(incomingByte == BUTTON_PRESSED) {
      leftPressed = false;
      rightPressed = false;
      forwardsPressed = false;
      backwardsPressed = false;
...
void setup() {
  ...
  connectWifi();
  myservo.attach(b1);
//  for (pos = 85; pos >= 25; pos -= 3) { // goes from 180 degrees to 0 degrees
//    myservo.write(pos);              // tell servo to go to position in variable 'pos'
//    delay(15);                       // waits 15ms for the servo to reach the position
//  }
}
